...
def buy_best_upgrade():
    ...
    for i in upgrades:
        try: a = i["toggle"]
            ...
            price = i["price"]
            print (id, efficiency_coeff*1000, i["profitPerHour"], price)
    ...
    #     print (f"[{formatted_date}] <b>Upgrade {most_efficient_upgrade[0]} is purcashed.</b>\nPrice {most_efficient_upgrade[2]}")
    #     return True
